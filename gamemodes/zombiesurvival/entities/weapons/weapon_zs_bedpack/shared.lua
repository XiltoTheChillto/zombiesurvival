...
SWEP.PrintName = "Bed Pack"
SWEP.Description = "It's simply a pack of bed frames kept together with some screws and duct tape.\nVery useful for making barricades when no materials are around.\nNeeds something like a hammer and nails to keep the things in place."

SWEP.ViewModel = "models/props_c17/FurnitureBed001a.mdl"
SWEP.WorldModel = "models/props_c17/FurnitureBed001a.mdl"
SWEP.UseHands = true
