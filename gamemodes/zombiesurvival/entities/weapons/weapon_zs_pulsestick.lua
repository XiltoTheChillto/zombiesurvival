...
SWEP.PrintName = "Pulse stick"
SWEP.Description = "Similar to the Boomstick but with decreased damage but the ability to slow zombies\nDO NOT UPGRADE THIS WEAPON ELSE IT WONT WORK PROPERLY"
