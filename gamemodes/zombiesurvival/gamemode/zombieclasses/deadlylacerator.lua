...
CLASS.Name = "Deadly Lacerator"
CLASS.TranslationName = "class_deadlylacerator"
...
CLASS.BetterVersion = "Deadly Armored Lacerator"
CLASS.Wave = 8 / 16

CLASS.Health = 950
CLASS.Speed = 300
CLASS.SWEP = "weapon_zs_deadlylacerator"
